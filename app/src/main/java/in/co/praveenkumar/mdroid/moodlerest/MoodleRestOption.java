...
public class MoodleRestOption {
	public static final String FUNCTION_CREATE_CONTACTS = "core_message_create_contacts";
	public static final String FUNCTION_DELETE_CONTACTS = "core_message_delete_contacts";
	...
	public static final String FUNCTION_GET_EXPERIENCE = "get_experience";
	public static final String FUNCTION_GET_FORUMS = "mod_forum_get_forums_by_courses";
	public static final String FUNCTION_GET_LEVEL = "get_level";
	public static final String FUNCTION_GET_MESSAGES = "core_message_get_messages";
	...
	public static final String FUNCTION_GET_USERS_FROM_COURSE = "core_enrol_get_enrolled_users";
